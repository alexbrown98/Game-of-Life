...
func gameOfLife(p golParams, keyChan <-chan rune) []cell {
	...
	pgm_alive_cells := make(chan []cell)

	dChans.io.cells_alive = pgm_alive_cells
	ioChans.distributor.cells_alive = pgm_alive_cells
